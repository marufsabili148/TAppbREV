  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-background">
        ...
        <MainContentWrapper maxWidth="2xl">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MainContentWrapper maxWidth="full">
        {/* User Info */}
        <Card className="bg-card border-border mb-8 lg:mb-10 max-w-2xl">
          <CardContent className="p-6 lg:p-8">
            <div className="flex items-center justify-between mb-4 gap-4 flex-col md:flex-row">
              <div className="flex items-center gap-4 flex-1 w-full">
                ...
                {isEditingName ? (
                  ...
                  <div className="flex-1">
                    <h2 className="text-lg lg:text-xl font-bold text-foreground">{user.name}</h2>
        ...
        <div className="mb-6 lg:mb-8">
          <h3 className="text-lg lg:text-2xl font-semibold text-foreground flex items-center gap-2">
